...
const Sushi = () => {
  ...
  useEffect(() => {
    const fetchPizza = async () => {
      try {
        const response = await fetch('http://localhost:8080/api/food/category/Sushi', {
      ...
      <section className="relative py-16" style={{ background: 'linear-gradient(135deg, #7B4019 0%, #FF7D29 100%)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
            Exquisite rolls and fresh sashimi, combining ocean-fresh fish with delicate rice
          </h2>
          <p className="text-xl text-white opacity-90 mb-8">
             A symphony of flavors and artistry in every bite.
          </p>
